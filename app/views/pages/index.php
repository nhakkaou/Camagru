...
<?php require APPROOT . '/views/inc/navbar.php'; ?>
        ...
        <div class="upload">
            <div class="e2"><a href="<?php echo URLROOT;?>/users/take_pic">Add Post</a>
            </div>
        </div><br>
            <br><br>
        ...
        <div class="postes card">
            ...
            <div class="cmnt_like">
               ...
               <?php endforeach; ?>
                <?php if ($l == TRUE):?>
                <i class="fas fa-kiss-wink-heart" onclick="like()" name="kiss" style="cursor: pointer;" id="like_<?php echo $post->id_img;?>" data-imgid='<?php echo $post->id_img;?>' data-userid='<?php echo $_SESSION['user_id'];?>'></i>Like
                <? else:?>
                <i class="far fa-kiss-wink-heart" onclick="like()" name="kiss" style="cursor: pointer;" id="like_<?php echo $post->id_img;?>" data-imgid='<?php echo $post->id_img;?>' data-userid='<?php echo $_SESSION['user_id'];?>'></i>Like
                <?php endif;?>
               <?php else : ?>
                    <i class="far fa-kiss-wink-heart" onclick="like()" name="kiss" style="cursor: pointer;" id="like_<?php echo $post->id_img;?>" data-imgid='<?php echo $post->id_img;?>' data-userid='<?php echo $_SESSION['user_id'];?>'></i>Like
                <?php endif;?>
    ...
    <div class="row">
        ...
        <ul class="pagination pagination-lg">
            ...
            <a class="page-link" href="<?php echo URLROOT.'/posts/index?page='.$i;?>"><?php echo $i;?></a>
            </li>
            <?php endfor;?>
        </ul>
            </div>
